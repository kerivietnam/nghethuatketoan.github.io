...
permalink: "/nguyen-ly-ke-toan/configuration/front-matter-defaults/"
---

Using [front matter](/nguyen-ly-ke-toan/front-matter/) is one way that you can specify configuration in the pages and posts for your site. Setting things like a default layout, or customizing the title, or specifying a more precise date/time for the post can all be added to your page or post front matter.
...
<div class="note info">
  ...
  <p>
    Note <a href="/nguyen-ly-ke-toan/datafiles">Data Files</a> are included and reloaded during automatic regeneration.
  </p>
</div>
...
With these defaults, all pages would use the `my-site` layout. Any html files that exist in the `projects/` folder will use the `project` layout, if it exists. Those files will also have the `page.author` [liquid variable](/nguyen-ly-ke-toan/variables/) set to `Mr. Hyde`.
...
[collection](/nguyen-ly-ke-toan/collections/) with the name `my_collection`.
